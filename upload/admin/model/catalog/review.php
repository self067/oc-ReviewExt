...
//		SELECT r.review_id, pd.name, r.author, r.rating, r.status, r.date_added FROM oc_review r LEFT JOIN oc_product_description pd ON (r.product_id = pd.product_id)  WHERE pd.language_id = 1;
